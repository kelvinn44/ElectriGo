-- Check if databases exist, drop them, and recreate
...
VALUES 
('john.doe@example.com', 'hashed_password_1', 'Basic', 'John', 'Doe', '1990-01-01', '123 Test Street, Singapore'),
('jane.smith@example.com', 'hashed_password_2', 'Premium', 'Jane', 'Smith', '1985-05-15', '456 Elm Street, Singapore');
...
CREATE TABLE Reservations (
    ...
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    FOREIGN KEY (user_id) REFERENCES ElectriGo_AccountDB.Users(user_id),
...
VALUES 
(1, 1, '2024-12-10 09:00:00', '2024-12-10 15:00:00', 'Active'),
(2, 2, '2024-12-11 09:00:00', '2024-12-11 15:00:00', 'Active');
...
CREATE TABLE Invoices (
    ...
    FOREIGN KEY (reservation_id) REFERENCES ElectriGo_VehicleDB.Reservations(reservation_id),
    FOREIGN KEY (user_id) REFERENCES ElectriGo_AccountDB.Users(user_id)
);
...
CREATE TABLE PaymentTransactions (
    ...
    payment_method ENUM('CreditCard', 'DebitCard', 'PayNow') NOT NULL,
...
VALUES 
('NEWYEAR2025', 10.00, '2024-12-01', '2025-01-01');
